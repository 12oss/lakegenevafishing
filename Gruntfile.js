	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/lakegenevafishing.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/lakegenevafishing.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/lakegenevafishing.css',
				dest: '_gh_pages/dist/css/min/lakegenevafishing.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/lakegenevafishing.js',
				dest: '_gh_pages/dist/js/min/lakegenevafishing.min.js'
			}
		},
		watch: {
			css: {
